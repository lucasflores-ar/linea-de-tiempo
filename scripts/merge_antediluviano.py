# -*- coding: utf-8 -*-
"""Fusiona sucesos antediluvianos en hechos_biblicos.csv desde curacion/jw_antediluviano.json.

Parchea hechos 1–5 y crea nuevos por clave. Idempotente.
Uso: python scripts/merge_antediluviano.py
"""
import csv
import json
import os
...
SPEC = repo('curacion', 'jw_antediluviano.json')
