...
P = [
 ...
 dict(nombre='Job',             inicio=-1670, fin=-1473, seccion='S1', grupo='Después del Diluvio',
      ini_est=1, fin_est=1,
      nota='Nacimiento y duración de vida desconocidos; estimado 1670–1473 a.e.c. (140 años después de la prueba de 1613)'),
